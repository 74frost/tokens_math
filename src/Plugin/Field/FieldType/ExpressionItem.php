...
class ExpressionItem extends FieldItemBase {
  ...
  public function fieldSettingsForm(array $form, FormStateInterface $form_state) {
    ...
    $element['default_zero'] = [
      ...
      '#description' => $this->t('Если значение выбраного токена отсутствует - рекомендуется использовать эту функцию во избежание ошибок, но помните - делить на 0 нельзя'),
